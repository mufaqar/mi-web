                ...
                <ul>
                    ...
                    <li >
                        <Link href="#experience">
                            <a className="text-white text-4xl p-3 bg-customPink hover:bg-white hover:text-black flex items-center group"><AiOutlineEye />
                            <div className="shadow-2xl w-32 h-14 absolute bg-white left-20 hidden group-hover:block duration-700">
                    ...
                    <li >
                        <Link href="#education">
                            <a className="text-white text-4xl p-3 bg-customPink hover:bg-white hover:text-black flex items-center group"><BiBriefcase />
                            <div className="shadow-2xl w-32 h-14 absolute bg-white left-20 hidden group-hover:block duration-700">
                                <p className="relative before:content-[''] before:w-5 before:h-5 before:bg-white before:absolute before:-left-2 before:top-5 before:transform before:rotate-45
                    ...
                    <li >
                        <Link href="#skills">
                            <a className="text-white text-4xl p-3 bg-customPink hover:bg-white hover:text-black flex items-center group"><GiGraduateCap />
                            <div className="shadow-2xl w-32 h-14 absolute bg-white left-20 hidden group-hover:block duration-700">
                                <p className="relative before:content-[''] before:w-5 before:h-5 before:bg-white before:absolute before:-left-2 before:top-5 before:transform before:rotate-45
