                ...
                <ul>
                    <li >
                        <Link href="#about">
                            ...
                            <div className="shadow-2xl  w-32 h-14 absolute bg-white left-[4.5rem] hidden group-hover:block duration-700">
                                ...
                                text-xs leading-[2rem] text-center font-bold text-black py-3 px-4 uppercase">About me</p>
                            </div>
                            </div>
                        </Link>
                    </li>
                    <li >
                        <Link href="#experience">
                            ...
                            <div className="shadow-2xl w-32 h-14 absolute bg-white left-[4.5rem] hidden group-hover:block duration-700">
                                ...
                                text-xs leading-[2rem] text-center font-bold text-black py-3 px-4 uppercase">Experience</p>
                            </div>
                            </div>
                        </Link>
                    </li>
                    <li >
                        <Link href="#education">
                            ...
                            <div className="shadow-2xl w-32 h-14 absolute bg-white left-[4.5rem] hidden group-hover:block duration-700">
                                <p className="relative before:content-[''] before:w-5 before:h-5 before:bg-white before:absolute before:-left-2 before:top-5 before:transform before:rotate-45
                                text-xs leading-[2rem] text-center font-bold text-black py-3 px-4 uppercase">Education</p>
                            </div>
                            </div>
                        </Link>
                    </li>
                    <li >
                        <Link href="#skills">
                            ...
                            <div className="shadow-2xl w-32 h-14 absolute bg-white left-[4.5rem] hidden group-hover:block duration-700">
                                <p className="relative before:content-[''] before:w-5 before:h-5 before:bg-white before:absolute before:-left-2 before:top-5 before:transform before:rotate-45
                                text-xs leading-[2rem] text-center font-bold text-black py-3 px-4 uppercase">Skills</p>
                            </div>
                            </div>
                        </Link>
                    </li>
